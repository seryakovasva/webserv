...
//
//            String xsdFile = "/home/sseryakova/webAppProjs/webservice/src/main/resources/xsd/rasp.xsd";
...
//            System.out.println(schedule.getPair());
//            for (Pair pair : schedule.getPair()) {
//
...
//        try {
//            File xmlFile = new File(name);
//            String xsdFile = "/home/sseryakova/webAppProjs/webservice/src/main/resources/xsd/groups.xsd";
...
//
//            System.out.println("Группы" + allGroups.getFaculty());
//
//            for (Faculty f : allGroups.getFaculty()) {
//                InfOfGroups infOfGroups = new InfOfGroups();
//                System.out.println("  Факультет: " + f.getFacultyName());
//                for (Course c : f.getCourses().getCourse()) {
//                    System.out.println("      Курс: " + c.getCourseNumber());
//                    for (Group g : c.getGroups().getGroup()) {
